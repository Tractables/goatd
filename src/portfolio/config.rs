...
impl PortfolioConfig {
    ...
    /// back only the time it needs to write its answer out.
    /// The sampling count caps how many seeds are drawn, not the
    /// clock, and a graph whose candidates are quick would otherwise finish the
