...
// that never calls this never links it. Carries goatd's licence, like the rest
// of the FFI shim; the heap it exercises is upstream's.
#include <climits>  // goatd: INT_MAX for the heap-overflow regression check
#include "ffi.h"
#include "heap.hpp"  // goatd: kway id-heaps under test by treedecomp_heap_selftest
